"""GitHub Models API client — OpenAI-compatible, uses GitHub PAT for auth.

Copilot Pro subscribers can access Claude and GPT models via
https://models.inference.ai.azure.com using a GitHub Personal Access Token.
"""
...
class GitHubModelsLLMClient:
    """Drop-in replacement for ClaudeLLMClient that calls GitHub Models API."""
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "openai package is required for GitHub Models. "
        ...
        self.client = OpenAI(
            ...
            max_retries=0,  # Disable SDK internal retries, handle ourselves
        )
        self.model = model
    ...
    def analyze(
        ...
        """Call GitHub Models API with retry. Same interface as ClaudeLLMClient."""
        schema_instruction = ""
        if output_schema:
